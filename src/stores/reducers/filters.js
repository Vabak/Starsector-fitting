...
const reducer = ( state = initialState, action ) => {
  switch ( action.type ) {
    case actionTypes.FETCH_SHIPS_BY_PARAM_START:
      return fetchShipsByParamStart( state, action );
    case actionTypes.FETCH_SHIPS_BY_PARAM_FAIL:
      return fetchShipsByParamFail( state, action );
    case actionTypes.FETCH_SHIPS_BY_PARAM_SUCCESS:
      return fetchShipsByParamSuccess( state, action );
    ...
    case actionTypes.PAGINATION_HANDLER:
